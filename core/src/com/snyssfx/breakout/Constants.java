...
public class Constants {
    ...
    public static final Color COLOR_LEVEL = new Color(0, 0, 0, 0);
    public static final Color COLOR_BOUNDS = Color.YELLOW; //new Color(0, 0, 0, 0);
    ...
    public static final float BALL_SPEED = 30.0f * BLOCKSIZE.x;
    ...
    public static final Vector2 LEVEL_1_POS = new Vector2(0, 21.0f * BLOCKSIZE.x);
    public static final Vector2 LEVEL_2_POS = new Vector2(0, 5.0f * BLOCKSIZE.x);
    public static final Vector2 LEVEL_3_POS = new Vector2(0, -9.0f * BLOCKSIZE.x);
    public static final Vector2 LEVEL_4_POS = new Vector2(0, -18.0f * BLOCKSIZE.x);
    public static final Vector2 LEVEL_5_POS = new Vector2(0, -24.0f * BLOCKSIZE.x);
